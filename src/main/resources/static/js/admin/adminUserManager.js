$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '登录账号', name: 'loginPhone', index: 'loginPhone', width: 50},
            {label: '用户邮箱', name: 'userEmail', index: 'userEmail', width: 80},
            {label: '手机号', name: 'phone', index: 'phone', width: 120},
            {label: '头像', name: 'avatarUrl', index: 'avatarUrl', width: 120, formatter: coverImageFormatter},
            {label: '身份状态', name: 'lock', index: 'lock', width: 60, formatter: lockedFormatter},
            {label: '是否注销', name: 'isExpire', index: 'isExpire', width: 60, formatter: deletedFormatter},
    ...
    function coverImageFormatter(cellvalue) {
        return "<img src='" + cellvalue + "' height=\"80\" width=\"80\" alt='头像'/>";
    }
