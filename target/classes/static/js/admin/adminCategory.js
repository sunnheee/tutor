$(function () {
    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '分类名称', name: 'subName', index: 'subName', width: 240},
            {label: '排序值', name: 'categoryRank', index: 'categoryRank', width: 120},
            {label: '是否删除', name: 'isExpire', index: 'isExpire', width: 80},
...
$('#saveButton').click(function () {
    ...
    if (!validCN_ENString2_18(subName)) {
